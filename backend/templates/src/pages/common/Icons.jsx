...
import FacebookIcon from '/logos/facebook.svg';
import InstagramIcon from '/logos/instagram.svg';
import TwitterIcon from '/logos/twitterx.svg';
import WhatsAppIcon from '/logos/whatsapp.svg';

const pot = <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256"><path
...
export { GoogleIcon, FacebookIcon, InstagramIcon, TwitterIcon, WhatsAppIcon, pot};